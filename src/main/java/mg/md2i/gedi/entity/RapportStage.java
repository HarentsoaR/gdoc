...
/**
 * Entite(rapportStage) avec mapping pour les tables de la BDD pour l'ENMG
 * http://www.md2i.eu 
...
public class RapportStage implements Serializable {
	...
	@Column(name="rp_cote", nullable =false)
	private String cote;
	...
	@Column(name="rp_nom", nullable =false)
	private String nom;


	@Column(name="rp_lieu", nullable =false)
	private String lieu;


	@Column(name="memoire_id", nullable =false)
	private Integer memoireId;

	@ManyToOne(cascade = CascadeType.ALL)
	@JoinColumn(name = "memoire_id", nullable = false, insertable=false , updatable=false)
	...
	@Column(name="rp_remarque", nullable =false)
	...
	public Integer getRapportStageId(){
		return rapportStageId;
	}
	public void setRapportStageId(Integer rapportStageId) { 
		this.rapportStageId = rapportStageId;
	}
